...
![AWS VPC architecture diagram showing the control-plane and two worker nodes secured by a self-referencing security group and connected over a Calico overlay network](images/kubeadm.png)
